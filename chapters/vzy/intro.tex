...
as there are no neutral \acp{QGC} or \acp{TGC} in the model. This makes the
...
which might introduce these `anomalous' neutral couplings.

The high number of electroweak interactions necessary at tree level to
