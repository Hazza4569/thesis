...
order to change the crossing angle, modifying the expected number of proton-proton
collisions induced for each bunch crossing.

% Luminosity
The rate at which collisions occur in the \ac{LHC} is given by the instantaneous
