...
The \ac{L1Calo} system, as used for Run 2 of the \ac{LHC} in the \ac{ATLAS}
detector, is described in Section X. %TODO reference relevant part of detector chapter
...
%Once Run 3 is complete, there will
%be another long shutdown in which further changes will be made in the Phase-II
