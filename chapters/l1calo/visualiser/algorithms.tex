...
The values of these variables are calculated immediately once the data for a
given \ac{TOB} is collected, or if the seed is re-specified, and displayed
...
with colours denoting whether those cells are used in the numerator
