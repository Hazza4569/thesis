...
\begin{figure}[tbph]
  \centering
  \fbox{
    \includegraphics[width=.44\textwidth,trim=0 0 0 5px,clip]{\resource{default_view_blank}}
  }
  \hfill
  \fbox{
    \includegraphics[width=.44\textwidth,trim=0 0 0 5px,clip]{\resource{default_view_filled}}
  }
  \caption{
    Initial interface on launching the \ac{eFEX} Visualiser program (left) and the default
    view once data is read from a file (right).
  }
