...
\begin{figure}[p]
  ...
  \caption{
    ...
    the \ac{CPM} (top) and \acs{eFEX} (bottom). Objects grouped in 20 GeV bins, with the last bin including
    all overflow.
  }
  \label{fig:trig-r3anal-matchrate}
\end{figure}
...
Figure \ref{fig:trig-r3anal-matchrate} and
shows the match rate for objects in Run
427885 as a function of energy, using \ac{CP}-measured and \ac{eFEX}-measured
energies. This shows that the bulk of the mismatches come from
low-energy objects, with a plateau in match rate above $E_T > 20$ GeV. At all
