...
This stepwise search is done in 6 different routes from the seed: one route
...
negative $\phi$. Figure \ref{fig:trig-eratio-algorithm-routes} cells, alongside
a schematic depicting the peak location strategy.
