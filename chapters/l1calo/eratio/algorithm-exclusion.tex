...
diagonal; this could stem from incident particles falling close to the corner of
a cell.
...
calorimeter, the performance for the \eratio algorithm with different exclusion
...
one-cell exclusion region performs best regardless or calorimeter geometry. The
difference between one-cell and two-cell is much more drastic in the high-$\eta$
