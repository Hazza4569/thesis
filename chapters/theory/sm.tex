...
% TODO give relation between cross-section and rate 'luminosity is a factor
% dependent on the experimental conditions, described in Section X'

A selection of \ac{SM} processes are shown in Figure \ref{fig:theory-sm-xsecs},
with measurements and predictions of their cross sections. The cross section of
a process is calculable from theory as a measure of the probability for a
particular process occurring, typically given in units of fb. Cross sections
relevant to \ac{VBS} \Zy production and \VZy production are given in the figure.
The given cross sections are `fiducial' cross sections, meaning they describe
the production rate only in a specific phase space, dependent on the analysis
selection involved.
...
\begin{sidewaysfigure}[p]
  ...
  \caption{
    ...
    Cross sections are corrected for branching fractions but subject to fiducial
