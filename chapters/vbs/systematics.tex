...
The systematic uncertainties used in this analysis are discussed in Section
\ref{sec:methods-systematics}. Figure \ref{fig:vbs-uncertainties-syst-overview}
illustrates the relative effect of the largest groups of systematics is shown on
both \ac{EW} and \ac{QCD} \Zyjj production, as a function of $m_{jj}$.
The uncertainty on the normalisation of the Z+jets fake photon background is
calculated following the prescription in Section
\ref{sec:methods-backgrounds-zjets-uncertainty} and determined to be 35\%
\cite{VBSZy-CONF}.
