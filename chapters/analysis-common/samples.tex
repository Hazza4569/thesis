...
well as
\pythia 8.240 \cite{pythia8dot2}. The \acp{DSID}
...
For the \QCDZy samples, Sample 2 (\acp{DSID} 345775-345782) is the nominal
...
\powhegbox v1 \cite{Nason2004,powheg,powhegbox} and \pythia 8.186
...
\madgraphfiveamc 2.3.3 and \pythia 8.212.  The \ac{QCD} and \ac{EW} production
modes for the \WZjj background are from Sample 6 (\ac{DSID} 364253), with
\sherpa 2.2.2, and Sample 7 (\acp{DSID} 364739-364742), with \madgraphfiveamc
2.6.2 and \pythia 8.235, respectively.
